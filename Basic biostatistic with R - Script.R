...
library(readr)
write_csv(data2, file = "data2.csv") # Will save into the working directory
...
#PART 5 - COMPARE MORE THAN TWO MEANS
...
#PART 7 - REPEATED MEASURES ANOVA
